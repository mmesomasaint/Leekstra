...
export default function Card({jobDoc, onClick}: {jobDoc: DocumentData, onClick: () => void}) {
  const job = useMemo(() => jobDoc.data(), [jobDoc])

  return (
    <div onClick={onClick} className='flex justify-start items-center gap-10 shadow-md rounded-2xl bg-gray-400/10 p-10'>
