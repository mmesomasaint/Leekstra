...
function Page() {
  ...
  const handleForm = async (e: FormEvent<HTMLFormElement>) => {
    ...
    // else if successful exit the modal
    router.back()
  }
  return (
    <div className='absolute inset-0 bg-black/30 w-full flex justify-center items-center'>
    <div className='flex justify-stretch items-center gap-0 bg-white shadow-xl rounded-md p-16'>
